...
-   `data`: Output data including a combined CSV file for the 2014-2024 reports and a GeoJSON file with the locations associated with that same period. As of July 2024, DOP staff are working to compile spatial data to publish along with a CSV file for the 2008-2013 reports.
